...
$sql=mysql_query("select * from $company where mark='mark'");
...
<div class="page">
  ...
  <header class="width100 header2">
    ...
    <div class="name f74 fl">商标申请</div>
  ...
  <div class="main">
    ...
    <section class="width100 box-bg-white mt20">
      <div class="clear"></div>
      <div class="case_t"><a href="/Cases/index"><img src="images/mark_t.jpg" class="width100" /></a></div>
