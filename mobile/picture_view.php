...
$name=$_GET["name"];
if($name=="office"){
$path="office/2017/"; $namedata="办公画册2017版";$note="画册内文尺寸230*305mm,120页(240P),157g铜板纸高光印刷高清质量.";
}
else if($name=="hotel"){
$path="hotel/2016/"; $namedata="酒店画册2016版";$note="画册内文尺寸230*305mm,144页(288P),157g铜板纸高光印刷高清质量,成品缺货。";
}
else if($name=="other"){
$path="office/other/"; $namedata="办公画册378P";$note="画册内文尺寸280*210mm(A4)，可全版设计定制，成品缺货。";
}
else{
$path="office/2017/";$namedata="办公画册2017版";$note="画册内文尺寸230*305mm,120页(240P),157g铜板纸高光印刷高清质量";
}
...
<div class="page">
  ...
  <div class="main">
    ...
    <section class="width100 box-bg-white mt20">
        <div class="sub_menu">
        <ul class="fix">
          <li <?php if($name=="office"){echo "class='sel'";}?>><a href="picture_view.php?name=office" class="f38">办公画册240P(2017)</a></li>
          <li <?php if($name=="hotel"){echo "class='sel'";}?>><a href="picture_view.php?name=hotel" class="f38">酒店画册288P(2016)</a></li>
		  <li <?php if($name=="other"){echo "class='sel'";}?>><a href="picture_view.php?name=other" class="f38">其他</a></li>
        </ul>
      </div>
      <div class="clear"></div>
      <div class="case_t"><img src="images/picture_t.jpg" class="width100" /></div>
